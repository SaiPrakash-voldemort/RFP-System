...
Demo Video: https://www.loom.com/share/9c364e4fd0064c4eacad2df052a01b42
...
PostgreSQL Database (Supabase recommended for SSL support)
...
3.  **Set Webhook:** Point the AgentMail webhook to your backend endpoint (e.g., `https://[your-ngrok-url]/api/webhook/email`).
    *   *Note: Since this is a local demo, you may need `ngrok` to expose your local server to the webhook.*

---
4. Database Setup
Run the initialization script to create tables (rfps, vendors, proposals).
...
Body: { "title": "Q1 Laptops", "raw_prompt": "I need 10 Macbooks..." }
...
Parses Email Subject to find RFP ID.

Downloads PDF attachment.

Extracts text using pdf-parse.

Sends text + Original Requirement to Groq AI.

AI extracts Price, Delivery Time, and generates a Score (0-100).
...
Demo
[Link to Demo Video]: https://www.loom.com/share/9c364e4fd0064c4eacad2df052a01b42